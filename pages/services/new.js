...
export default function NewService() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validações básicas
    if (!formData.title || !formData.description || !formData.price || !formData.deliveryTime) {
    ...
    try {
      ...
      setError(error.message || 'Ocorreu um erro ao criar seu serviço. Por favor, tente novamente.');
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth: '800px' }}>
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <input
            ...
            placeholder="Ex: Desenvolvimento de Website Completo"
          />
        </div>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <textarea
            ...
            placeholder="Descreva detalhadamente o serviço que você oferece, sua experiência e diferenciais..."
          />
        </div>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          ...
          >
            {submitting ? 'Enviando...' : 'Cadastrar Serviço'}
          </button>
